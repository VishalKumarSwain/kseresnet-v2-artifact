...
class KSERESNETv4(pb2_grpc.CompetitionToolServicer):
    def __init__(self):
        print("Loading KSERESNET-V4 (offline ranking-trained) ...")
        self.model = ResNetPredictorV2(in_channels=IN_CH)
        checkpoint = torch.load("crash_model_v4.pth", map_location="cpu")
    ...
    def Name(self, request, context):
        return pb2.NameReply(name="KSERESNET-V4")
...
def serve():
    ...
    server.start()
    print("KSERESNET-V4 listening on 50051 ...")
