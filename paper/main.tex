...
losses and 8 ties; $\hat{A}_{12}=0.950$, $p<10^{-25}$) -- architecture
...
did not have access to reproduce, not to the architecture per se.
...
the epoch-count row, $N=160$ trials for the other two.}
\label{tab:design}
...
choice on their own. \textbf{External.} All experiments use a single dataset
